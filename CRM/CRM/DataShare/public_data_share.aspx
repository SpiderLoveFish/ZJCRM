<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="public_data_share.aspx.cs" Inherits="XHD.CRM.CRM.DataShare.public_data_share" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#tree1").ligerTree({
                url: 'public_data_share.aspx?cmd=tree&rnd=' + Math.random(),
                onSelect: onSelect,
                idFieldName: 'id',
                usericon: 'd_icon',
                checkbox: false,
            ...
            $("#maingrid4").ligerGrid({
                ...
                dataAction: 'server',
                url: "public_data_share.aspx?cmd=grid&categoryid=0&rnd=" + Math.random(),
                pageSize: 30,
        ...
        function onSelect(note) {
            ...
            var url = "public_data_share.aspx?cmd=grid&categoryid=" + note.data.id + "&rnd=" + Math.random();
        ...
        function doserch() {
            ...
            var manager = $("#maingrid4").ligerGetGridManager();
            manager.GetDataByURL("public_data_share.aspx?" + serchtxt);
        }
        ...
        function view(id) {
            var dialogOptions = {
                width: 770, height: 510, title: "共识资料查看", url: 'CRM/DataShare/public_data_view_share.aspx?pid=' + id + '&rnd=' + Math.random(), buttons: [
                        {
