...
namespace XHD.CRM.CRM.Help
{
    public partial class help_share : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (cmd == "grid")
            {
                try
                {
                    ...
                    sb.AppendLine("    @viewName='V_public_help' , -- varchar(800) ");
            ...
            else if (cmd == "tree")
            {
                try
                {
                    ...
                    sb.AppendLine("SELECT * FROM dbo.V_public_help_category");
            ...
            else if (cmd == "form")
            {
                try
                {
                    ...
                    sb.AppendLine("FROM dbo.V_public_help ");
