...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../../data/public_help_category.ashx", /* 注意后面的名字对应CS的方法名称 */
                ...
                success: function (result) {
                    ...
                    $("#T_category_name").val(obj.category);
                    $("#T_category_icon").val(obj.icon);
                    $("#menuicon").attr("src", "../../" + obj.icon);
                    ...
                    $("#T_category_parent").ligerComboBox({
                        ...
                        tree: {
                            ...
                            url: '../../data/public_help_category.ashx?Action=combo&rnd=' + Math.random(),
                            idFieldName: 'id',
    ...
    <form id="form1" onsubmit="return false">
        <table border="0" cellpadding="3" cellspacing="1" style="background: #fff; width: 400px;">
            ...
            <tr>
                ...
                <td height="23" >
                    <input type="text" id="T_orderid" name="T_orderid" value="20"  ltype='spinner' ligerui="{type:'int',width:180}"  ligerui="{width:180}" validate="{required:true}"/>
                </td>
            </tr>
        </table>
    </form>
