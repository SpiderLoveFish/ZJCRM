<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Jifen_kh_add.aspx.cs" Inherits="Jifen.Jifen_kh_add" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadForm() {
            ...
            $.ajax({
                type: "GET",
                url: "Jifen_kh_add.aspx?cmd=form&jid=" + getparastr("jid") + "&rnd=" + Math.random(),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    var obj = eval(data);
    ...
    <form id="form1" onsubmit="return false;">
        <table style="width: 500px; margin: 5px;" class='bodytable1'>
            ...
            <tr>
                ...
                <td>
                    <div style="text-align: left; float: left">
                        <input type="text" id="Khmc" name="Khmc" ltype="text" ligerui="{width:150,disabled:true}" validate="{required:false}" />
                    </div>
                </td>
                <td>
                ...
                <td>
                    <input type="text" id="Khdh" name="Khdh" ltype="text" ligerui="{width:150,disabled:true}" validate="{required:false}" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" id="Khxb" name="Khxb" ltype="text" ligerui="{width:150,disabled:true}" validate="{required:false}" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="text" id="Khxq" name="Khxq" ltype="text" ligerui="{width:415,disabled:true}" validate="{required:false}" />
                </td>
            </tr>
            <tr>
                <td>
