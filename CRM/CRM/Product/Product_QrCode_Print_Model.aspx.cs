...
{
    public partial class Product_QrCode_Print_Model : System.Web.UI.Page
    {
        ...
        protected void DLMain_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            ...
            try
            {
               prid1= Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "product_id1"));
            }
            catch { }
          ...
          
            {
                ...
                try
                {
                    prid2 = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "product_id2"));
                }
                catch { }
