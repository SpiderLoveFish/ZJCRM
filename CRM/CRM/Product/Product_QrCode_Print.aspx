<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product_QrCode_Print.aspx.cs" Inherits="XHD.CRM.CRM.Product.Product_QrCode_Print" %>
                    ...
                    <td >
                        <table  border="0" style="border:1px solid #000000; width:300px;height:450px" cellpadding="0"cellspacing="1">
                            ...
                            <tr style="height:30px">
                             ...
                             <tr ><td colspan="2" style=" vertical-align:top;    word-break:break-all;"><asp:Label ID="lbremarks1"    CssClass="dd"  runat="server"></asp:Label></td></tr>
                        </table>                        
                    </td>
                        ...
                        <asp:Panel ID="p2"  runat="server">
                         <table  border="0" style="border:1px solid #000000; width:300px;height:450px" cellpadding="0"cellspacing="1">
                            ...
                            <tr style="height:30px">
                             ...
                             <tr ><td colspan="2" style=" vertical-align:top ; word-break:break-all;"><asp:Label ID="lbremarks2"    CssClass="dd"  runat="server"></asp:Label></td></tr>
                        </table>
                       </asp:Panel>
                    </td>
