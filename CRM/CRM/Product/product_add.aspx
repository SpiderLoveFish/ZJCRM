            ...
            $.ajax({
                ...
                success: function (result) {
                   ...
                   // $("#T_gys").val(obj.Suppliers);
                    ...
                    $("#T_product_unit").ligerComboBox({ width: 280, url: "../../data/Param_SysParam.ashx?Action=combo&parentid=16&rnd=" + Math.random(), emptyText: '（空）', initValue: obj.unit });
                    $("#T_gys").ligerComboBox({ width: 280, url: "../../data/Crm_product.ashx?Action=combogys&rnd=" + Math.random(), emptyText: '（空）', initValue: obj.Suppliers });
