               ...
               success: function (result) {
                   ...
                   $.each(obj, function (i, data) {
                       ...
                       if (data['ComponentName'] != cn) {
                           ...
                           item = "<tr><td align='left' colspan='6' ><font size='3' ><b>&nbsp;&nbsp;" + data['ComponentName'] + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(合计：" + toMoney(data['BwSubTotal']) + ")</b></font></td></tr>"
                           + "<tr><td >" + data['brand']
                          // + "<td align='right'>" + data['zc_price'].toFixed(2) + "</td><td align='right'>" + toMoney(data['fc_price']) + "</td><td align='right'>" + toMoney(data['rg_price'])
                           + "</td><td align='right'>" + toMoney(data['TotalPrice']) + "</td><td align='right'>" + sum.toFixed(2) + "</td> "
                               + " <td align='right'>" + toMoney(data['je']) + "</td><td  align=center>" + data['unit'] + "</td> <td>" + data['proremarks'] + "</td>"
                               //.replace(/\n|\r|(\r\n)|(\u0085)|(\u2028)|(\u2029)/g, "<br>")
                               + " </tr>";
                       }
                       else {
                           item = "<tr><td>" + data['brand'] + "</td>"
                            //   + "</td><td align='right'>" + toMoney(data['zc_price']) + "</td><td align='right'>" + toMoney(data['fc_price']) + "</td><td align='right'>" + toMoney(data['rg_price'])
                               + "<td align='right'>" + toMoney(data['TotalPrice']) + "</td><td align='right'>" + sum.toFixed(2) + "</td> "
                               + " <td align='right'>" + toMoney(data['je']) + "</td><td  align=center>" + data['unit'] + "</td> <td>" + data['proremarks'] + "</td>"
                               + " </tr>";
                       }
                       $('.table1').append(item);
               ...
               success: function (result) {
                   ...
                   $.each(obj, function (i, data) {
                       ...
                       item = "<tr><td>" + data['ComponentName'] + "</td> "
                          ...
                          + "</td> <td  align='right'>" + toMoney(data['zje']) + "</td>"
                          + " </tr>";
                       $('.table2').append(item);
...
<DIV style="LINE-HEIGHT: 30px"  align="center">  <table width="100%"  border=0 cellSpacing=0 cellPadding=0>
    <tr>
      ...
      <td width="50%" align="center"><STRONG><font size="5" ><span id="T_BudgetName"></span></font></STRONG>

  <!--<STRONG><font size="6" >预算清单 </font></STRONG>-->

      </td>
      <td  width="30%"  align="right"><strong><font size="2"><span id="T_logo"></span>（<SPAN id="T_pid" ></SPAN> ）</font></strong></td>
    </tr>
    <tr>
...
<tr>
 <td valign="top" >
<TABLE   class="table2 table-striped table-bordered table-condensed"border=1 cellSpacing=0 cellPadding=1 width="90%" style="border-collapse:collapse;font-size:15px" bordercolor="#333333">
<thead>
 ...
 <td valign="top" >
<TABLE   class="table3 table-striped table-bordered table-condensed"border=1 cellSpacing=0 cellPadding=1 width="90%" style="border-collapse:collapse;font-size:15px" bordercolor="#333333">
<thead>
