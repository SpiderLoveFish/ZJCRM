...
<script type="text/javascript">
    ...
    function getPoint() {
        $.ajax({
            url: "../../data/CRM_Customer.ashx?Action=getGYSMapList&type=map",
            type: "POST",
            ...
            success: function (data) {
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    // 创建信息窗口对象
                    info[i] = "<div style='margin:0;line-height:20px;padding:2px;'>" + "【地址】：" + rows[i].address + "</br> 【电话】：" + rows[i].Gsdh + "</div>";
                    //创建百度样式检索信息窗口对象                       
                    searchInfoWindow[i] = new BMapLib.SearchInfoWindow(map, info[i], {
                        title: "【供应商】" + rows[i].Name,      //标题                        
                        panel: "panel",         //检索结果面板
