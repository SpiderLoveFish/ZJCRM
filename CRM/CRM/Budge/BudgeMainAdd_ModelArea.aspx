        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#T_PerSquarePrice").val(obj.PerSquarePrice);//平米单价
                    $("#T_sAmount").val(obj.StandardAmount);//标准金额
                    //$("#T_PerSquarePrice").val(obj.PerSquarePrice);//面积
                    //$("#T_SquareAmount").val(obj.SquareAmount);//面积
                    //$("#T_yh").val(obj.SquareAmount - obj.zje)
            ...
            <tr    >
              ...
              <td class="table_title1"><input type="text"  id="T_zje2" name="T_zje2"  ltype="text" ligerui="{width:80,disabled:true}"   /></td>
               ...
               <tr>
                 ...
                 <td colspan="4"   class="table_title1"><input id="T_remarks" name="T_remarks" type="text" ltype="text"  ligerui="{width:330}" /></td>
                    <td   class="table_title1">套餐价: <input id="T_sAmount" name="T_sAmount" type="text" ltype="text"  ligerui="{width:60}" /></td>

                    <td   class="table_title1">平米单价:<input id="T_PerSquarePrice" name="T_PerSquarePrice" validate="{required:false}"  ltype="text" ligerui="{width:60}"  /></td>
                 <td   class="table_title1">标准面积㎡:<input id="T_smj" name="T_smj" validate="{required:false}"  ltype="text" ligerui="{width:60}"  /></td>
