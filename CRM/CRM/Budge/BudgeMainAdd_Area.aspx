...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#T_mj").val(obj.SquareMeter);//面积
                    $("#T_PerSquarePrice").val(obj.PerSquarePrice);//面积单价
                    $("#T_SquareAmount").val(obj.SquareAmount);//总价
                    $("#T_yh").val(obj.SquareAmount - obj.zje)//优惠
                    $("#T_smj").val(obj.StandardArea);//标准面积
                    $("#T_sAmount").val(obj.StandardAmount);//标准金额
        ...
        function addcustomer() {
            ...
            $.ajax({
                type: 'post',
                url: "../../data/Budge.ashx?Action=saveadd&type=mj&ISZB=" + getparastr("ISZB") + "&mj=" + $("#T_mj").val() + "&bid=" + $("#T_budgeid").val() + "&cid=" + $("#T_companyid").val() + "&remarks=" + $("#T_remarks").val() + '&bname=' + $("#T_budge_name").val() + '&rdm=' + Math.random(),
                success: function (data) {
                    if (data == 'false') {
                        getmaxid();
        ...
        function selectmodel() {
            top.$.ligerDialog.open({
                ...
                url: "CRM/Budge/SelectModel.aspx?ismj=Y",
                buttons: [
        ...
        function f_selectmodel(item, dialog) {
            ...
            $.ajax({
                url: "../../data/Budge.ashx", type: "POST",
                data: { Action: "savemodeltobudge", bid: $("#T_budgeid").val(), modelid: rows.id, savemodeltobudge: rows.PerSquarePrice, rnd: Math.random() },
                success: function (responseText) {
                    top.$.ligerDialog.closeWaitting();
                    if (responseText == "false") {
                        dialog.frame.f_error();
                        ...
                        $("#T_PerSquarePrice").val(rows.PerSquarePrice);//引用后，类型变为引用的模板类型
                        $("#T_smj").val(rows.StandardArea);//标准面积
                        $("#T_sAmount").val(rows.StandardAmount);//标准金额
                        $("#T_yh").val(0);//优惠
                        $("#T_SquareAmount").val(0);//优惠
            ...
            <tr    >
              ...
              <td class="table_title1"><input type="text"  id="T_zje2" name="T_zje2"  ltype="text" ligerui="{width:80,disabled:true}"   /></td>
               ...
               <tr>
                 ...
                 <td colspan="2"   class="table_title1"><input id="T_remarks" name="T_remarks" type="text" ltype="text"  ligerui="{width:230}" /></td>
                <td   class="table_title1">面积单价:<input id="T_PerSquarePrice" name="T_PerSquarePrice" type="text" ltype="text"  ligerui="{width:60,disabled:true}" /></td>
                   <td   class="table_title1"> 总价: <input id="T_SquareAmount" name="T_SquareAmount" type="text" ltype="text"  ligerui="{width:60,disabled:true}" /></td>

                    <td   class="table_title1">优惠:<input id="T_yh" name="T_yh" validate="{required:false}"  ltype="text" ligerui="{width:60}"  /></td>
                 <td   class="table_title1">面积㎡:<input id="T_mj" name="T_mj" validate="{required:false}"  ltype="text" ligerui="{width:60}"  /></td>
                 <td   class="table_title1"> 套餐价：<input id="T_sAmount" name="T_sAmount" validate="{required:false}"   ltype="text" ligerui="{width:60,disabled:true}" />  </td>
                 <td   class="table_title1">标准面积㎡: <input id="T_smj" name="T_smj" validate="{required:false}"  ltype="text" ligerui="{width:60,disabled:true}" /> </td>
                 ...
                 <td   class="table_title1" ><input id="T_employee2" name="T_employee2" validate="{required:false}"  ltype="text" ligerui="{width:60,disabled:true}"  /></td>
               </tr>
               <tr id="tr2">
