   ...
   <script src="../../lib/ligerUI/js/plugins/ligerDialog.js" type="text/javascript"></script>
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '材料编号', name: 'product_id', width: 0, align: 'left',hide:true },
    ...
    //监听键盘事件
        ...
        function f_select() {
            ...
            var r = { "productid": rows.product_id, "C_code": rows.C_code, "product_name": rows.product_name, "ProModel": rows.ProModel, "specifications": rows.specifications, "Brand": rows.Brand, "productnumber": 1 };
            return r;
