<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Building.aspx.cs" Inherits="Building.Building" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
           // //debugger;
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "Building.aspx?cmd=grid&rnd=" + Math.random(),
                width: '100%',
                height: '100%',
                heightDiff: -1,
        ...
        function toolbar() {
            ...
            $.getJSON("../../data/toolbar.ashx?Action=GetSys&mid=5&rnd=" + Math.random(), function (data, textStatus) {
                ...
                items.push({ type: 'textbox', id: 'stext', text: '楼盘名称：' });
        ...
        function doserch() {
            ...
            manager.GetDataByURL("Building.aspx?" + serchtxt);
        }
        function add() {
        ...
        function edit() {
            ...
            if (row) {
                f_openWindow("CRM/Building/Building_Add.aspx?cid=" + row.ID, "楼盘维护", 600, 400);
            }
            else {
        ...
        function del() {
            ...
            if (row) {
                $.ligerDialog.confirm("确定删除？", function (yes) {
                    if (yes) {
                        $.ajax({
                            url: "Building_Add.aspx?cmd=del&cid=" + row.ID + "&rnd=" + Math.random(), type: "POST",
        ...
        function f_save(item, dialog) {
            ...
            if (issave) {
                ...
                $.ajax({
                    url: "Building_Add.aspx", type: "POST",
                    data: issave,
                    beforesend: function () {
