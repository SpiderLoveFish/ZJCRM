...
<head>
   ...
   <link href="../../lib/ligerUI/skins/ext/css/ligerui-all.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '部门', name: 'Customer', width: 80, align: 'left' },
                    { display: '采购员', name: 'cgy', width: 80, align: 'left' },
                ...
                url: "../../data/Purchase.ashx?Action=grid&type=GSYP&Apr="+Apr,
                width: '100%',
                height: '100%',
        ...
        //查询
        function doserch() {
            var sendtxt = "&Action=grid&type=GSYP&Apr="+Apr+"&rnd=" + Math.random();
      ...
      function add() {
          f_openWindow("crm/purchase/PurchaseMainAdd_GSYP.aspx?status=0", "新增采购", 1100, 600);
        }
        ...
        function edit() {
            ...
            if (row) {
               // alert(row.isNode);
                if (row.isNode == 0)
                    f_openWindow("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&isauto=" + row.customid+"&status=" + row.isNode, "审核采购单", 1200, 600);
                else if (row.isNode == 1)//已经提交
                {
                    if (getparastr("Apr") == 'Y')
                        f_openWindow_sh("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&status=" + row.isNode + "&style=apr", "审核采购单", 1200, 600, '审核');
                  else 
                        f_openWindow_ch("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&status=" + row.isNode + "&style=ret", "审核采购单", 1200, 600, '撤回');
                ...
                else if (row.isNode == 2)//已经提交
                {
                    ...
                    if (getparastr("Apr") == 'YY')
                        f_openWindow_sh("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&status=" + row.isNode + "&style=apry", "审核采购单", 1200, 600, '确认');
                    else
                        f_openWindow_ch("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&status=" + row.isNode + "&style=ret", "审核采购单", 1200, 600, '撤回');
                    ...
                    if (getparastr("Apr") == 'YYY')
                        f_openWindow_sh("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&status=" + row.isNode + "&style=apryy", "回单采购单", 1200, 600, '确认');
                    else
                        f_openWindow_ch("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&status=" + row.isNode + "&style=ret", "回单采购单", 1200, 600, '撤回');

                  //  f_openWindow_ch("crm/purchase/PurchaseMainAdd_GSYP_CK.aspx?pid=" + row.Purid + "&status=" + row.isNode + "&style=apry", "审核采购单", 1100, 600, '确认');
        ...
        function view() {
            ...
            if (row) {
                ...
                f_openWindowview("crm/purchase/PurchaseMainAdd_GSYP.aspx?pid=" + row.Purid + "&isauto=" + row.customid + "&status=" + row.isNode, "查看采购单", 1100, 600);
