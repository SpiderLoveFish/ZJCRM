   ...
   <script src="../../lib/ligerUI/js/plugins/ligerDialog.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var strurl ="../../data/Purchase.ashx?Action=tempgriddb&cid=" + getparastr("cid");
            $("#maingrid4").ligerGrid({
                columns: [
                    //{ display: 'ID', name: 'ID', type: 'int', width: 50 },
                    { display: '序号', width: 50, render: function (rowData, rowindex, value, column, rowid, page, pagesize) { return (page - 1) * pagesize + rowindex + 1; } },
                    { display: '材料编号', name: 'material_id', width: 80, align: 'left' },
                    { display: '材料名称', name: 'material_name', width: 100, align: 'left' },
                  ...
                  { display: '可用数量', name: 'subtotal', width: 100, align: 'left' },
    ...
    //监听键盘事件
        ...
        function add() {
            ...
            for (var item = 0; item < rows.length; item++)
                prouductid += ',' + rows[item].material_id;
            if (prouductid == '') {
                $.ligerDialog.error("请至少选择一个有效材料数据！");
                return;
            }
            var strurl = "../../data/Purchase.ashx?Action=savedetaildb&cid=" + getparastr("cid")+"&pid=" + getparastr("pid") + "&bjlist=" + prouductid + '&rdm=' + Math.random();
