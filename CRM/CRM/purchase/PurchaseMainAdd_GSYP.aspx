    ...
    <script type="text/javascript">
        ...
        $(function () {
           ...
           // $('input:checkbox').ligerCheckBox();
            ...
            if (getparastr("pid") != null) {
                ...
                $('#T_employee').ligerComboBox({ width: 80, onBeforeOpen: f_selectcgy });
                $('#T_employee2').val(getCookie("username"));
                var cur = new Date();
        ...
        function loadForm(oaid) {
             $.ajax({
                ...
                data: { Action: 'formgsyp', pid: oaid, rnd: Math.random() }, /* 注意参数的格式和名称 */
                ...
                success: function (result) {
                   ...
                   // alert(obj.CustomerID); //String 构造函数
                    ...
                    $("#T_companyname").val(obj.Customer );
        ...
        function f_selectcgy() {
            top.$.ligerDialog.open({
                ...
                url: "hr/Getemp_Auth.aspx?auth=1", buttons: [
                    { text: '确定', onclick: f_selectContactcgyOK },
                    { text: '取消', onclick: f_selectContactCancel }
                ]
            });
            return false;
        ...
        function f_selectContact() {
            top.$.ligerDialog.open({
                ...
                //url: " hr/Getemp_Auth.aspx?auth=1", buttons: [
                url: "hr/hr_department.aspx", buttons: [
        ...
        function f_selectContactcgyOK(item, dialog) {
        ...
        function addpur()
        {
           ...
           // var isAccept = ck.getValue();
            ...
            $.ajax({
                type: 'post',
                url: "../../data/Purchase.ashx?Action=savetemp&pid=" + $("#T_Pid").val() + "&cid=" + $("#T_companyid").val() + "&remark=" + $("#T_remarks").val() + '&supid=' + $("#T_gysid").val() + '&isgd=' + isgd + '&cgy=' + encodeURI($("#T_employee").val()) +'&rdm=' + Math.random(),
                success: function (data) {
                    if (data == 'false') {
                        getmaxid();
                        $.ligerDialog.error("保存错误！！！重新保存！");
    ...
    <form id="form1" onsubmit="return false">
        ...
        <table style="width: 550px; margin: 5px;" class='bodytable1'>
            ...
            <tr>
             ...
             <td   ><span style="width: 60px; text-align: right; float: right">采购员：</span></td>
                 <td   ><input id="T_employee" name="T_employee" validate="{required:false}"  ltype="text" ligerui="{width:80,disabled:true}"  /></td>
                 <td   ><span style="width: 60px; text-align: right; float: right">录入人：</span></td>
