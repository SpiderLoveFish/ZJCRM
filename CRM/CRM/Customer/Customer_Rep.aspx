...
<%--     
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var urlheadcol = "../../data/crm_customer.ashx?Action=gridrep&rnd=" + Math.random();
            reflash(urlheadcol);
        ...
        function dosearch() {
            ...
            var sendtxt = "Action=gridrep&rnd=" + Math.random();
        ...
        function view_follow(kh,customertype) {
            ...
            if (sectype == "")
                sectype = "Employee";
            f_openWindowview("CRM/Customer/Customer.aspx?type=CX&kh=" + encodeURI(kh) + "&CType=" + encodeURI(customertype) + "&sectype=" + sectype, "客户查看", 867, 600);
