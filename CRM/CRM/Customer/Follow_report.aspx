...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                 ...
                 { display: '跟进类型', name: 'Follow_Type', width: 80 },
                    {
                            display: '客户', name: 'Customer', align: 'left', width: 250, render: function (item) {
                        ...
                        {
                            display: '跟进次数', name: 'cs', align: 'left', width: 60, render: function (item) {
                                var html = "<div class='abc'><a href='javascript:void(0)' onclick=viewcs(" + item.Customer_id + ",'" + item.Follow_Type+"')>";
                                if (item.cs)
                                    html += item.cs;
                                html += "</a></div>";
                                return html;
                        ...
                        //{ display: '跟进次数', name: 'cs', width: 180 },
                         
                        {
                            display: '首次时间', name: 'Follow_date', width: 140, render: function (item) {
                                return formatTimebytype(item.Follow_date, 'yyyy-MM-dd hh:mm');
                            }
                        },
                        {
                            display: '最新时间', name: 'Follow_date_', width: 140, render: function (item) {
                                return formatTimebytype(item.Follow_date, 'yyyy-MM-dd hh:mm');
                            }
                        },
                        { display: '未跟天数', name: 'ts', width: 60 }
                        //{
                ...
                //checkbox:true,
                url: "../../data/CRM_Follow.ashx?Action=grid1",
        ...
        function doserch() {
            var sendtxt = "&Action=grid1&rnd=" + Math.random();
        ...
        function viewcs(id, type) {
            f_openWindow_view('CRM/Customer/Customer_follow.aspx?cid=' + id + '&type=' + type   ,  "客户明细", 660, 550);
