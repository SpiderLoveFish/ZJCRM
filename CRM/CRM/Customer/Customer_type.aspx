...
<head>
   ...
   <script src="../../lib/ligerUI/js/plugins/ligerGrid.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#maingrid4").ligerGrid({
                columns: [
                   ...
                   { display: '类型编号', name: 'typeid', width: 100, align: 'left' },
                   { display: '名称', name: 'params_name', width: 80, align: 'left' },
                   { display: '标准跟进小时', name: 'followhours', width: 120, align: 'left' },
                ...
                url: "../../data/Customer_type.ashx?Action=grid",
                width: '100%',
                height: '100%',
        ...
        function add() {
            f_openWindow("crm/Customer/Customer_type_add.aspx", "新增进度属性维护", 650, 400);
        }
        ...
        function edit() {
            ...
            if (row) {
                f_openWindow("crm/Customer/Customer_type_add.aspx?id=" + row.id, "修改进度属性", 650, 400);
            } else {
        ...
        function del() {
            ...
            if (row) {
                $.ligerDialog.confirm("删除不能恢复，确定删除？", function (yes) {
                    if (yes) {
                        $.ajax({
                            url: "../../data/Customer_type.ashx", type: "POST",
