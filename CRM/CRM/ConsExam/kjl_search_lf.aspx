   ...
   <script type="text/javascript">
     ...
     function ajaxhxtapi(keystr) {
         $.ajax({
             ...
             data: { Action: "gridkjl_account_list", islf: "Y", keystr: keystr, rnd: Math.random() },
             success: function (responseText) {
                 // alert(responseText);
...
<div class="section clearfix">
  ...
  <div class="ntitle">
    ...
    我的所有方案&nbsp;&nbsp;(在上方进行搜索，点击结果中的户型图创建)&nbsp;&nbsp;<button class="btn-gray" onclick='syncdata()'>更新</button>
...
<%--         <li>
        <a title="清新有活力的公寓设计 用色彩焕然一新" href="1.aspx">
          <span class="abs-bg"></span>
