...
<body>
    <form id="form1" onsubmit="return false">
        ...
        <table style="width: 250px; margin: 5px;" class='bodytable1'>
            <tr>
                <td colspan="4" class="table_title1">工地申请领用材料</td>
            </tr>
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">材料名称：</div>
                </td>
                <td>
                 ...
                 <td>
                    <div style="width: 80px; text-align: right; float: right">材料型号：</div>
                </td>
                <td>
                    <div style="width: 140px; float: left">
              ...
              <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">材料规格：</div>
                </td>
                <td>
                    <div style="width: 140px; float: left">
                 ...
                 <td>
                    <div style="width: 80px; text-align: right; float: right">材料品牌：</div>
                </td>
                <td>
                    <div style="width: 140px; float: left">
            ...
            <tr>
                ...
                <td>
                    <div style="width: 80px; text-align: right; float: right">单位：</div>
                </td>
            ...
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">厂商已送达：</div>
                </td>
                <td>
                    <input id="Text5" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">仓库已送达：</div>
                </td>
                 <td>
               ...
               <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">商发出在途：</div>
                </td>
                <td>
                    <input id="Text4" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">仓发出在途：</div>
                </td>
                <td>
                     <input id="Text7" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            </tr> 
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">本次厂商送：</div>
                </td>
                <td>
                    <input id="Text9" name="T_company_tel" type="text" ltype="text" ligerui="{width:136}" validate="{required:true}"  /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">本次仓库送：</div>
                </td>
                <td>
                    <input id="Text10" name="T_company_tel" type="text" ltype="text" ligerui="{width:136}" validate="{required:true}"  /></td>
            </tr>  
             <tr>
                <td colspan="4" align="center" style="color:red">
                    本次厂商到达数量 ≤ 厂商发出在途数量  |  本次仓库到达数量 ≤ 仓库发出在途数量
                    </br>厂商到达操作成功后，增加已到达数量，减少发出在途数量。仓库送达同理。
                </td>
            </tr>      
             <tr>
                <td>
