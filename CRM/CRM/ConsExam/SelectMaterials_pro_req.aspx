...
<body>
    <form id="form1" onsubmit="return false">
        ...
        <table style="width: 250px; margin: 5px;" class='bodytable1'>
            ...
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">配料数量：</div>
                </td>
                <td>
                    <input id="Text5" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">已申请数量：</div>
                </td>
                <td>
             ...
             <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">可申请数量：</div>
                </td>
                <td>
                    <input id="Text4" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">本次申请：</div>
                </td>
                <td>
             ...
             <tr>
                <td colspan="4" align="center" style="color:red">
                                   本次申请数量 ≤ 配料数量-已申请量 &nbsp;     &nbsp;     &nbsp;     &nbsp;    并且 </br>
                    已申请+本次申请 ≥ 采购在途+在库数量+发出在途+到达工地(控制减少申请的逻辑）</td>
            </tr>     
             <tr>
                <td>
