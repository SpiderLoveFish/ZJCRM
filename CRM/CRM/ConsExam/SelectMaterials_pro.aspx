...
<head>
   ...
   <script src="../../lib/ligerUI/js/plugins/ligerGrid.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                   ...
                   //  { display: '材料编号', name: 'C_code', width: 80, align: 'left' },
                     ...
                     { display: '材料型号', name: 'ProModel', width: 80, align: 'left' },
                        { display: '材料规格', name: 'specifications', width: 80, align: 'left' },
                         { display: '所属品牌', name: 'Brand', width: 80, align: 'left' },
                          //{ display: '类别', name: 'category_name', width: 80, align: 'left' },
                        { display: '单位', name: 'unit', width: 40, align: 'left' },
                        {
                            display: '选材数量', name: 'AmountSum', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' } 
                             
                        },
                          {
                              display: '申请领用', name: 'Amount_req', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }

                          },
                            {
                                display: '采购在途', name: 'Amount_pus', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }

                            },
                             {
                                 display: '在库数量', name: 'Amount_sto', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }

                             },
                             {
                                 display: '厂商发出', name: 'Amount_dil_p', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }

                             },
                               {
                                   display: '库存发出', name: 'Amount_dil_s', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }

                               },
                              {
                                  display: '厂商送达', name: 'Amount_dil_p', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }

                              },
                                {
                                    display: '仓库送达', name: 'Amount_dil_s', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }

                                },
                                {
                                    display: '未处理', name: 'AmountSum', width: 60, align: 'right'
                            , type: 'int', editor: { type: 'int' }
        ...
        function toolbar() {
            $.getJSON("../../data/toolbar.ashx?Action=GetSys&mid=207&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function req() {
           // tempDoStyle = "ALL";
            f_openWindow("../../CRM/ConsExam/SelectMaterials_pro_req.aspx?&cid=" + getparastr("cid"), "申请领用材料", 520, 310);


        }
        function pus() {
            // tempDoStyle = "ALL";
            f_openWindow("../../CRM/ConsExam/SelectMaterials_pro_pus.aspx?&cid=" + getparastr("cid"), "转入采购环节", 520, 310);


        }
        function sto() {
            // tempDoStyle = "ALL";
            f_openWindow("../../CRM/ConsExam/SelectMaterials_pro_sto.aspx?&cid=" + getparastr("cid"), "库存可用数量", 520, 400);


        }
        function dil() {
            // tempDoStyle = "ALL";
            f_openWindow("../../CRM/ConsExam/SelectMaterials_pro_dil.aspx?&cid=" + getparastr("cid"), "材料领用发出", 520, 330);


        }
        function ino() {
            // tempDoStyle = "ALL";
            f_openWindow("../../CRM/ConsExam/SelectMaterials_pro_ino.aspx?&cid=" + getparastr("cid"), "工地收货确认", 520, 330);
