   ...
   <script src="../../lib/ligerUI/js/plugins/ligerGrid.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function f_save(data, pid)
        {
            ...
            var datas = "Action=savebj&jmid=" + jmid + "&style=" + style + "&tel=" + tel;
            if (data.action !== 'kjl_rendered') {
                datas = datas +
                    "&fid=" + fid +
                    "&desid=" + desid +
        ...
        function openurl() {
            window.open("../../WebSite/bj/list_1.aspx?jmid=" + jmid + "&tel=" + tel + "&desid=" + desid);
        }
        ...
        function gethxtmc(fid,desid,savedata)
        {
           // alert(desid + fid)
            if (fid == ""||fid ==null)//如果fid为空
            {
                $.ajax({
                    ...
                    error: function () {
                        ...
                        top.$.ligerDialog.error('保存失败desid！', "", null, 9003);
                    }
                });
            }
            else
            {
                $.ajax({
                    ...
                    error: function () {
                        ...
                        top.$.ligerDialog.error('保存失败fid！', "", null, 9003);
                    }
                });
            }
        }
            ...
            $(function () {
                ...
                $.ajax({
                    url: "../../data/website.ashx", type: "POST",
                    data: { Action: "GetMD5",jmid:jmid, dest: dest, desid: desid, fid: fid, rnd: Math.random() },
