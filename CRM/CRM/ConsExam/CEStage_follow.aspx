...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                        ...
                        {
                            display: '客户姓名', name: 'Customer_name', align: 'left', width: 80, render: function (item) {
                                var html = "";
                                //"<a href='javascript:void(0)' onclick=view(1," + item.Customer_id + ")>";
                ...
                //checkbox:true,
                url: "../../data/CRM_CEstage_Follow.ashx?Action=grid",
        ...
        function doserch() {
            ...
            manager.GetDataByURL("../../data/CRM_CEstage_Follow.ashx?" + serchtxt);
