...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    //    }
                    //},
                    { display: '考核明细名称', name: 'CEStage_name', width: 200 }
        ...
        function edit() {
            ...
            if (rows.length == 1)
                f_openWindow('crm/ConsExam/CEStage_Detail_add.aspx?pid=' + rows[0].CEStage_id + '&pdid=' + rows[0].CEStage_detail_id, "修改考核", 790, 600);
            else
        ...
        function add() {
            ...
            if (notes != null && notes != undefined) {
                f_openWindow('crm/ConsExam/CEStage_Detail_add.aspx?categoryid=' + notes.data.id, "新增考核", 790, 600);
            }
            else {
        ...
        function prt() {
            ...
            if (rowid.length > 0)
                ViewwStyle(rowid);
                //print_openWindow("crm/CEStage/CEStage_QrCode_Print.aspx?id=" + rowid, "打印考核", 700, 700);
