    ...
    <script type="text/javascript">
        ...
        function edit() {
            ...
            if (row) {
                ...
                f_openWindow('crm/ConsExam/CEStage_Detail_add.aspx?categoryid=' + row.StageID + '&catname=' + row.Description + '&catdetailid=' + row.StageDetailID, "修改考核", 790, 500);
            }
            else
        ...
        function add() {
            ...
            if (notes != null && notes != undefined) {
                f_openWindow('crm/ConsExam/CEStage_Detail_add.aspx?categoryid=' + notes.data.id+'&catname='+notes.data.text, "新增考核", 790, 500);
            }
            else {
