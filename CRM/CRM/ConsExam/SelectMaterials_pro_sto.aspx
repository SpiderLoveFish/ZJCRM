...
<body>
    <form id="form1" onsubmit="return false">
        ...
        <table style="width: 250px; margin: 5px;" class='bodytable1'>
            <tr>
                <td colspan="4" class="table_title1">确认材料库存</td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">施工申请量：</div>
                </td>
                <td>
                    <input id="Text5" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">已在库数量：</div>
                </td>
                <td class="auto-style1">
             ...
             <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">可用数量：</div>
                </td>
                <td>
                    <input id="Text4" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">本次确认：</div>
                </td>
                <td class="auto-style1">
                    ...
                    <td>
                        <div align="right" style="width: 80px">
                            扣减采购量：
                                ...
                                <td>
                                    <input type="radio" value="1" name="jbx"  />是 &nbsp;  &nbsp; <input type="radio" value="0" name="jbx" checked="checked" />否</td>
                   
                                <td colspan="2" style="color:gray">选是，则增加在库同时减少采购在途</td>
             ...
             <tr>
                <td colspan="4" align="center" style="color:red">
                    扣减采购选“是”，可认为本次在库数量由采购入库所得。 且本次确认≤采购在途<br />
                    选否，则认为库存中已有此材料，规则如下：<br />
                                   本次确认库存数量 ≤ 施工申请数量-采购的途-已在库数量-发出在途-到达工地 &nbsp;    并且 </br>
                    本次确认在库+已确认在库 ≥  0
                </td>
            </tr>     
             <tr>
