...
<body>
    <form id="form1" onsubmit="return false">
        ...
        <table style="width: 250px; margin: 5px;" class='bodytable1'>
            <tr>
                <td colspan="4" class="table_title1">材料采购</td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
             ...
             <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">可再采购量：</div>
                </td>
                <td>
                    <input id="Text4" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">本次采购：</div>
                </td>
                <td>
             ...
             <tr>
                <td colspan="4" align="center" style="color:red">
                                   本次可采购数量 ≤ 施工申请数量-采购的途-在库数量-发出在途-到达工地 &nbsp;    并且 </br>
                    本次采购+采购在途 ≥ 0
                </td>
            </tr>     
             <tr>
