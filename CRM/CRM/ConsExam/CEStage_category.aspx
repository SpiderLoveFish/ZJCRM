...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    {
                        display: '图标', name: 'CEStage_icon', width: 50, render: function (item) {
                            return "<div style='margin-top:3px;'><img src='../../" + item.CEStage_icon + "'/></div>";
                        }
                    }
                ],
                dataAction: 'local',
        ...
        function add() {
            f_openWindow("crm/ConsExam/CEStage_category_add.aspx", "新增类别", 480, 320);
        }
        ...
        function edit() {
            ...
            if (row) {
                f_openWindow('crm/ConsExam/CEStage_category_add.aspx?cid=' + row.id, "修改类别", 480, 320);
            } else {
        ...
        function del() {
            ...
            if (row) {
                $.ligerDialog.confirm("类别删除不能恢复，确定删除？", function (yes) {
                    if (yes) {
                        $.ajax({
                            url: "../../data/Crm_CEStage_category.ashx", type: "POST",
