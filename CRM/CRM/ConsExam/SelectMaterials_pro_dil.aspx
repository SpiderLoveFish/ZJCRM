    ...
    <form id="form1" onsubmit="return false">
        ...
        <table style="width: 250px; margin: 5px;" class='bodytable1'>
            ...
            <tr>
              ...
              <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">厂商已发料：</div>
                </td>
                <td>
                    <input id="Text4" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">仓库已发料：</div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">采购在途：</div>
                </td>
                <td>
                    <input id="Text5" name="T_company_tel" type="text" ltype="text" ligerui="{width:136,disabled:true}"" /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">在库数量：</div>
                </td>
                 <td>
            ...
            <tr>
                <td>
                    <div style="width: 80px; text-align: right; float: right">本次厂商发：</div>
                </td>
                <td>
                    <input id="Text9" name="T_company_tel" type="text" ltype="text" ligerui="{width:136}" validate="{required:true}"  /></td>
            
                <td>
                    <div style="width: 80px; text-align: right; float: right">本次仓库发：</div>
                </td>
                <td>
             ...
             <tr>
                <td colspan="4" align="center" style="color:red">
                    本次厂商发料数量 ≤ 采购在途  |  本次仓库发料数量 ≤ 在库数量
                    </br>厂商发料操作成功后，增加发出在途，减少采购在途。仓库发料同理。
                </td>
            </tr>      
             <tr>
                <td>
