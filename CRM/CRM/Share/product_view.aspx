    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (getparastr("id")) {
                ...
                $('#T_CK').ligerComboBox({ width: 196, url: "../../data/CKKW.ashx?Action=combo&type=CK&rnd=" + Math.random(), emptyText: '（空）', onSelected: function (newvalue, newtext) { onSelect(newvalue, newtext); } });
                comkwg = $("#T_KW").ligerComboBox({
                    width: 196, url: "../../data/CKKW.ashx?Action=combo&type=0&rnd=" + Math.random()
                });
        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("[T_private]").val("1");
                    $('#T_CK').ligerComboBox({ width: 196, url: "../../data/CKKW.ashx?Action=combo&type=CK&rnd=" + Math.random(), emptyText: '（空）', initValue: obj.CKID, onSelected: function (newvalue, newtext) { onSelect(newvalue, newtext); } });
                    comkwg = $("#T_KW").ligerComboBox({
                        width: 196, url: "../../data/CKKW.ashx?Action=combo&type=" + obj.CKID + "&rnd=" + Math.random(), initValue: obj.KWID
                    });
...
<body>
    <form id="form1" onsubmit="return false">     
        <table align="left" border="0" cellpadding="3" cellspacing="1">
                ...
                <td >基本信息</td> <td >请先选择材料类型：</td><td colspan="7" ><input id="T_style" name="T_style" type="text" ltype="select"
            ...
            <tr>
                 <td>
                    <div style="width: 80px; text-align: right; float: right">仓库：</div>
                </td>
                <td>
                    <div style="width: 100px; float: left">
                        <input type="text" id="T_CK" name="T_CK" />
                         
                    </div>
                   
                </td>
                 <td>
                    <div style="width: 80px; text-align: right; float: right">库位：</div>
                </td>
                <td>
                    <div style="width: 100px; float: left">
                      <input type="text" id="T_KW" name="T_KW" />
