<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Jcb_Ckgl_Add.aspx.cs" Inherits="Jcb_Ckgl.Jcb_Ckgl_Add" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function loadForm(cid) {
            $.ajax({
                type: "GET",
                url: "Jcb_Ckgl_Add.aspx?cmd=form&cid=" + cid + "&rnd=" + Math.random(),
