...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                onSelectRow: function (data, rowindex, rowobj) {
                    ...
                    var url = "../../data/CRM_Cope.ashx?Action=grid&Apr=view&orderid=" + data.Purid;
                    manager.GetDataByURL(url);
                },
                dataAction: 'server', pageSize: 30, pageSizeOptions: [20, 30, 50, 100],
                url: "../../data/Purchase.ashx?Action=grid&rnd=" + Math.random(),
                width: '100%', height: '65%',
                heightDiff: -1,
            ...
            $("#maingrid5").ligerGrid({
                columns: [
                    ...
                    {
                        display: '查看', width: 60, render: function (item) {//61,
                            var html = "<a href='javascript:void(0)' onclick=view_cope('" + item.order_id + "'," + item.id + ")>查看</a>";
                            return html;
                        }
                    }
                ...
                dataAction: 'server', pageSize: 30, pageSizeOptions: [20, 30, 50, 100],
                //checkbox:true,
                url: "../../data/CRM_Cope.ashx?Action=grid&orderid=0&rnd=" + Math.random(),
        ...
        function view_cope(id,id1) {
            f_openWindow_view('CRM/finance/CRM_Cope_invoice_add.aspx?orderid=' + id + "&receiveid=" + id1, "应付单", 770, 490);
        ...
        function add() {
            ...
            if (row) {
                f_openWindow("CRM/finance/CRM_Cope_add.aspx?orderid=" + row.Purid, "添加收款", 870, 490);
            }
            else {
        ...
        function edit() {
            ...
            if (row) {
                ...
                f_openWindow('CRM/finance/CRM_Cope_add.aspx?orderid=' + row.Purid + "&receiveid=" + row.id, "修改收款", 770, 490);
        ...
        function del() {
            ...
            if (row) {
                $.ligerDialog.confirm("您确定要删除吗？", function (yes) {
                    if (yes) {
                        $.ajax({
                            url: "../../data/CRM_Cope.ashx", type: "POST",
