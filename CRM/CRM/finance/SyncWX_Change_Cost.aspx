...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#T_cwny').val(thisYear + thisMonth)
            
        })
        function f_save() {
            if ($('#T_cwny').val() == "" || $('#T_cwny').val() == null)
            {
                alert('财务年月须填入！');
                return;
            }
            //if ($(form1).valid()) {
            var sendtxt = "&Action=savesync&cwny=" + $('#T_cwny').val();
        ...
        <table style="width: 550px; margin: 5px;" class='bodytable1'>
            ...
            <tr>
                <td>
                  ...
                  <td>
                    <input id="T_cwny" name="T_cwny" type="text" ltype="text" ligerui="{width:180 }" validate="{required:false}" /></td>
