    ...
    <script type="text/javascript">
        ...
        function loadorder(orderid) {
            $.ajax({
                ...
                data: { Action: 'formmain', pid: orderid, rnd: Math.random() }, /* 注意参数的格式和名称 */
                ...
                success: function (result) {
                    ...
                    $("#T_Customer_val").val(obj.customid);

                    //$("#T_department0").val(obj.C_dep_name);
                    //$("#T_employee0").val(obj.C_emp_name);
                    // Order_amount
                    $("#T_order_amount").val(toMoney(obj.payable_amount));
                    $("#T_receive_amount").val(toMoney(obj.paid_amount));
                    $("#T_arrears_amount").val(toMoney(obj.arrears));
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../../data/CRM_Cope_invoice.ashx", /* 注意后面的名字对应CS的方法名称 */
