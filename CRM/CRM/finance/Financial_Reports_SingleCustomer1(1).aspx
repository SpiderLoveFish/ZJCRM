        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '摘要', name: 'summary', width: 90 },
                    { display: '摘要', name: 'Price', width: 100 },
                    { display: '数量', name: 'QTY', width: 90 },
                    { display: '预算单数', name: 'BudgeQty', width: 90 },
                    { display: '预算金额', name: 'BudgeAmount', width: 100 },
                    { display: '收款金额', name: 'CollectedAmount', width: 90 },
                    { display: '材料成本', name: 'MaterialCost', width: 90 },
                    { display: '人工成本', name: 'LabourCost', width: 100 },
                    { display: '公司利润', name: 'CompanyProfit', width: 90 },
                    { display: '施工利润', name: 'ConstructionProfit', width: 90 },
                    { display: '业务利润', name: 'BusinessProfit', width: 90 },
                    { display: '设计利润', name: 'DesignProfit', width: 90 },
