...
<head  >
    ...
    <script type="text/javascript">
        ...
        function computer()
        {
            ...
            var je = Number($("#T_ysje").val()) + Number( $("#T_sje").val());
            var zje =  Number($("#T_zje").val())
            if (je > zje)
            {
                alert("应收金额不能大于总金额！");
                $("#T_ysje").val("0")
...
<body style="margin:5px 5px 5px 5px">
    ...
    <div>
        <table  align="left" border="0"   cellspacing="1" 
                ...
                <td colspan="3" >
                    <div style="float:left; height: 20px;">
                        <input  id="T_rperson" name="T_rperson"     ligerui="{width:220}" validate="{required:true}" />
                         <input  id="T_person_val" name="T_person_val"   type="hidden" />
                          <input  id="T_person" name="T_person"   type="hidden" />
                    </div>
                </td>
            </tr>
            <tr height="30px">
            ...
            <tr>
                <td>
                    <div align="left" style="width: 62px">是否有明细：</div></td>
                <td  colspan="2">
              ...
              <tr height="30px">
                <td  >
                    ...
                    <div align="left" style="width: 62px">总金额：</div></td>
                <td  >
                    <div style="float:left; height: 20px;">
                ...
                <td  >
                    ...
                    <div align="left" style="width: 80px">应收金额：</div></td>
                <td  >
                    <div style="float:left; height: 20px;">
                                <input type="text" id="T_ysje" name="T_ysje"   onchange="computer()"  onfocus="computer()"      ltype="text"   ligerui="{width:180}" validate="{required:true}"/>
              ...
              <tr height="30px">
                <td  >
                    ...
                    <div align="left" style="width: 80px">已收金额：</div></td>
                <td  >
                    <div style="float:left; height: 20px;">
                        <input type="text" id="T_sje" name="T_sje"        ltype="text"   ligerui="{width:180,disabled:true}" validate="{required:true}"/>
                    </div>
                </td>
                   <td  >
