    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (getparastr("fid")) {
                ...
                $("#T_fylx").ligerComboBox({ width: 196, url: "../../data/Param_SysParam.ashx?Action=combo&parentid=28&rnd=" + Math.random(), emptyText: '（空）' });
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../../data/Financial_Fixed_Cost.ashx", /* 注意后面的名字对应CS的方法名称 */
                ...
                success: function (result) {
                    ...
                    $("#T_year").val(year);
                    $("#T_month").val(mounth);
                    $("#T_fylx").ligerComboBox({ width: 196, url: "../../data/Param_SysParam.ashx?Action=combo&parentid=28&rnd=" + Math.random(), emptyText: '（空）', initValue: obj.F_StyleID });
                    $("#T_je").val(obj.Amount);
...
<body style="margin:5px 5px 5px 5px">
    ...
    <div>
        <table align="left" border="0"   cellspacing="1" style="background: #fff; width:550px;">
            <tr>
                ...
                <td   > <input type="text" id="T_fylx" name="T_fylx" /></td> 
            </tr>
            <tr>
                <td  >
                ...
                <td class="auto-style1"  >
                 ...
                 <td  >
                    ...
                    <div align="left" style="width: 62px">关联人员：</div></td>
                <td  >
                    <div style="float:left; height: 30px;">
