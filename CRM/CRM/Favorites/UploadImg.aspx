...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //preview($("#photo"), {"x1":50,"y1":50,"x2":200,"y2":200,"width":120,"height":120});
           //api.cancelSelection();
        });
        function uploadimg() {
            ...
            if (type == ".jpg" || type == ".gif" || type == ".jpeg" || type == ".bmp" || type == ".png") {
                $("#form1").ajaxSubmit({
                    ...
                    data: { Action: 'upload1', filename: filename, rnd: Math.random() }, /* 注意参数的格式和名称 */
                    ...
                    success: function (result) {
                        ...
                        api = $('#photo').imgAreaSelect({
                            ...
                            show: true,
                            x1: 0, y1: 75, x2: 150, y2: 150
                        });
                        preview($("#photo"), { "x1": 0, "y1": 150, "x2": 150, "y2": 150, "width": 150, "height": 75 });
                    }
                });
            }
        }
        ...
        <div class="container demo">
            <fieldset>
                ...
                <div style="float: left; width: 150px;">
                    ...
                    <div class="frame" style="margin: 0 1em; width: 150px; height: 75px;">
                        <div id="preview1" style="width: 150px; height: 75px; overflow: hidden;">
