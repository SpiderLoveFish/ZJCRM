...
<head>
    ...
    <script type="text/javascript">
        //图标
        var jpname = ""; var params_id = ""; var customerid = "";
        $(function () {
          ...
          params_id = getparastr("params_id");
        ...
        function f_selectContact() {
            top.$.ligerDialog.open({
                zindex: 9003,
                title: '选择金牌项目', width: 850, height: 400,

                //url: " hr/Getemp_Auth.aspx?auth=1", buttons: [
                url: "System/alarm_select_xm.aspx", buttons: [
        ...
        function f_selectContactOK(item, dialog) {
            ...
            $('#T_company').val("【" + data.XMMC + "】"  );
            $('#T_tel').val(data.tel)
            loadFormJP(data.XMID);
            //customerid = data.XMPX;
            //alert(customerid)
            dialog.close();
        }
        ...
        function f_save_yy() {
            var sendtxt = "&Action=saveyy&params_id=" + getparastr("params_id") + "&name=" + decodeURI(getparastr("name")) ;
        ...
        <table border="0" cellpadding="3" cellspacing="1" style="background: #fff; width: 99%;">
            <tr>
               ...
               <tr>
                ...
                <td height="33"><div style="width: 70px; text-align: right; float: right">金牌项目：</div></td>
