...
<head>
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            if (row) {
                f_openWindow('System/Param_City_add.aspx?pid=' + row.id + '&stype=add', "新增", 390, 200);
            } else {
                f_openWindow('System/Param_City_add.aspx?stype=add', "新增", 390, 200);
            }
        }
        ...
        function edit() {
            ...
            var row = manager.getSelectedRow();
            if (row) {
                f_openWindow('System/Param_City_add.aspx?pid=' + row.id + '&stype=edit', "修改", 390, 200);
            } else {
