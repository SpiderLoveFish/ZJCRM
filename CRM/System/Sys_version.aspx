            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.version_name == sys_version) {
                        ...
                        $.ligerDialog.warn("有"+result.version_name+"版本可以更新，请前往 <a herf='http://www.xhdcrm.com/down'>小黄豆CRM官网</a> 下载更新。")
                    }
                }
            })
        }
    ...
    <form id="form1">
        <table class="bodytable0" style="width: 100%; margin: -1px">
            ...
            <tr>
                ...
                <td height="23">
                    <span id="Label4"><input type="button" value="检查更新" style="width:80px;height:22px;"></span>
                </td>
            </tr>
        </table>
    </form>
