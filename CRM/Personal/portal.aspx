...
<head>
    ...
    <script type="text/javascript">
        ...
        function notice() {  //公告提醒
            ...
            //});
            $.getJSON("../data/public_notice.ashx?Action=noticeremind1&rnd=" + Math.random(), function (data, textStatus) {
                var obj = eval(data);
                var notice = $("<div style='text-align:center;font-size:large;font-weight:bold;'>" + obj.Rows[0].notice_title + "</div>");
                $("<div style='text-align:left;'>" + myHTMLDeCode(obj.Rows[0].notice_content) + "</div>").appendTo(notice);
                $("<div style='text-align:left;'>" + formatTimebytype(obj.Rows[0].notice_time, 'yyyy-MM-dd') + "</div>").appendTo(notice);
                notice.appendTo($("#c_notice"));
            });
        }
        ...
        function dofunnel(GridData) {
            ...
            $("#imarquee").text("恭喜本月过生日的家人： 心成装饰携全体员工祝他们生日快乐！");
            $("#ibirthday").hide();
        }
    </script>
    <style type="text/css">
...
<body style="overflow-y: scroll;">
    <div style="padding: 5px;">
        <div id="ibirthday" style="width: 98.5%;color:red;border:1px dotted red;">
            <marquee id="imarquee" scrolldelay="200" onmouseover="this.stop();" onmouseout="this.start();"></marquee>
        </div>
        <div style="width: 100%;margin-top:5px;" id="portalMain">
        </div>
    </div>
