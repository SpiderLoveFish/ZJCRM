    ...
    public class login : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (request["Action"] == "logout")
            {
                ...
                if (null != cookie)
                {
                    ...
                    try
                    {
                        ...
                        context.Session.Remove("qmmessage");
                        context.Session.Remove("access_token");
                        context.Session.Remove("client_id");
                        context.Session.Remove("openid");
                    }
                    catch
                    {
                    }
            ...
            if (request["Action"] == "qq_login")
            {
                ...
                string login_url = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=" + client_id + "&state=" + state + "&redirect_uri=" + Utils.UrlEncode(redirect_uri) + "&scope=get_user_info,get_info,get_other_info";
                //写日志
                Logs.logSave("===========================================分割线=============================================");
                //写日志
                ...
                //开始发送
                context.Response.Write(login_url);
