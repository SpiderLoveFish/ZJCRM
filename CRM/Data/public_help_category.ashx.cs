...
{
    /// <summary>
    /// public_help_category 的摘要说明
    /// </summary>
    public class public_help_category : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            BLL.public_help_category ccpc = new BLL.public_help_category();
            Model.public_help_category model = new Model.public_help_category();
            ...
            if (request["Action"] == "save")
            {
                ...
                if (!string.IsNullOrEmpty(id) && id != "null")
                {
                    ...
                    else
                    {
                        ...
                        string EventType = "帮助类别修改";
                        int EventID = model.id;
                        if (dr["category"].ToString() != request["T_category_name"])
                        {
                            log.Add_log(UserID, UserName, IPStreet, EventTitle, EventType, EventID, "帮助类别", dr["category"].ToString(), request["T_category_name"]);
                        }
            ...
            if (request["Action"] == "del")
            {
                ...
                BLL.public_help product = new BLL.public_help();
