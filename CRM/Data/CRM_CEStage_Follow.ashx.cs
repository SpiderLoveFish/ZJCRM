...
namespace XHD.CRM.Data
{
    ...
    /// CRM_Follow 的摘要说明
    /// </summary>
    public class CRM_CEStage_Follow : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            BLL.CRM_CEstage_Follow follow = new BLL.CRM_CEstage_Follow();
            Model.CRM_CEstage_Follow model = new Model.CRM_CEstage_Follow();
