...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                        ...
                        {
                            display: '人员姓名', name: 'Customer_name', align: 'left', width: 80, render: function (item) {
                                var html = "<a href='javascript:void(0)' onclick=view(9," + item.Customer_id + ")>";
                ...
                //checkbox:true,
                url: "../../data/hr_socialWorker_Follow.ashx?Action=grid",
        ...
        function initSerchForm() {
            var c = $("#followtype").ligerComboBox({ width: 194, url: "../../../data/Param_SysParam.ashx?Action=combo&parentid=20&rnd=" + Math.random() });
        ...
        function doserch() {
            ...
            manager.GetDataByURL("../../data/hr_socialWorker_Follow.ashx?" + serchtxt);
    ...
    <div class="az">
        <form id='serchform'>
            <table style='width: 780px' class="bodytable1">
                <tr>
                    <td>
                        <div style='width: 60px; text-align: right; float: right'>人员姓名：</div>
                    </td>
                    <td>
