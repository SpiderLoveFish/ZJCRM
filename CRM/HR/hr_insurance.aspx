    ...
    <script type="text/javascript">
        $(function () {
            $("#maingrid4").ligerGrid({
                columns: [
                  ...
                  //  { display: '生日', name: 'birthday' },
                    ...
                    { display: '默认职务', name: 'zhiwu' },
                    {
                     ...
                     {
                         display: '交保险', width: 150, render: function (item) {
                             var html = "";// "<div style='margin-top:5px;'><input type='checkbox'";
                             if (item.jbx == 1) html += "交社保";//"checked='checked'  ";
                             if (item.jbx == 2) html += "交意外保险";
                             if (item.jbx == 3) html += "交社保&意外保险";
                             //html += " disabled='disabled' /></div>";
                             return html;
                         }
                     },
                ...
                url: "../data/hr_employee.ashx?Action=grid&thtype_val=1,2,3",
                width: '100%',
                height: '100%',
                //title: "员工列表",
                heightDiff: -1,
