...
<body style="margin-top: -1px">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var socialWorkerId = getparastr("socialWorkerId") ? getparastr("socialWorkerId") : 0;
            ...
            var op = {
                ...
                //autoload:true,
                url: "../../data/hr_socialWorker_Calendar.ashx?Action=get&socialWorkerId=" + socialWorkerId,
            ...
            function View(data) {
                ...
                if (data) {
                    ...
                    //}
                    //else {                   
                        var eurl = "HR/hr_socialWorker_Calendar_add.aspx?id=" + vid;
                        f_openWindow(eurl, "查看日程", 620, 380);
                    //}
                }
            }
