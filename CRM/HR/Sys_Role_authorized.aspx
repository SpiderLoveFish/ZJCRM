       ...
       // var treemanager;
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                enabledEdit: true,
                checkbox: true,
                url: "../data/Sys_role.ashx?action=apptreegrid",
        ...
        function f_setbtn()
        {
            ...
            $.ajax({
                type: 'post',
                url: "../data/Sys_role.ashx?Action=getappauth&postdata=" + roleid + '&rdm=' + Math.random(),
        ...
        function f_save() {
            ...
            //    var app = notes.data.id;
               ...
               // f_saving();
                $.ajax({
                    type: 'post',
                    url: "../data/Sys_role.ashx?Action=saveappauth&postdata=" + savetext + '&rdm=' + Math.random(),
                    success: function (data) {
                        //alert(data);
                        setTimeout(function () {
                           f_success();
        ...
        function gridreload(Appid) {
            ...
            var url = "../data/Sys_Menu_data.aspx?action=apptreegrid&appid=" + Appid;
            manager.GetDataByURL(url);
        };
