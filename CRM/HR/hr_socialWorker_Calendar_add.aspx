        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#T_Rclx").val(obj.Follow_Type); //日程类型
                    $("#T_starttime").val(formatTime(obj.StartTime, 'yyyy-MM-dd hh:mm'));
                    $("#T_endtime").val(formatTime(obj.EndTime, 'yyyy-MM-dd hh:mm'));
                    ...
                    <td>
                        <table style="width: 450px">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" id="T_Rclx" name="T_Rclx"  style="width: 150px" readonly="readonly" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <textarea cols="100" id="T_content" name="T_content" rows="6" class="l-textarea" style="width: 376px" validate="{required:true}" readonly="readonly" ></textarea></td>
                            </tr>
                        </table>
                    </td>
                </tr>
