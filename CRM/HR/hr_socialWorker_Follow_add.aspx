...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../../data/hr_socialWorker_Follow.ashx", /* 注意后面的名字对应CS的方法名称 */
                ...
                success: function (result) {
                    ...
                    $("#T_followtype").ligerComboBox({ width: 352, initValue: obj.Follow_Type_id, url: "../../data/Param_SysParam.ashx?Action=combo&parentid=20&rnd=" + Math.random() });          
                    $("#T_starttime1").ligerDateEditor({ format: 'yyyy-MM-dd' });
                    $("#T_starttime1").val(formatTime(obj.StartTime));
                    $("#T_endtime1").ligerDateEditor({ format: 'yyyy-MM-dd' });
                    $("#T_endtime1").val(formatTime(obj.EndTime));
                    
                    $("#T_content1").val(obj.Subject);
                }
            });
    ...
    <form id="form1" onsubmit="return false">
        <table class="bodytable1" style="width: 500px; margin: 2px;">
            ...
            <tr>
                ...
                <td style="width: 85px">
                    <div style="width: 80px; text-align: right; float: right">跟进类型：</div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <textarea id="T_follow" cols="6" name="T_follow" class="l-textarea" style="width: 350px;" rows="6" validate="{required:true}"></textarea></td>
                            ...
                            <tr>
                <td class="table_title1" colspan="2">相关时间记录</td>
            </tr>
                        <tr id="tr5">

                <td style="width: 85px">
                    <div style="width: 80px; text-align: right; float: right">时间区间：</div>
                </td>
                <td>
                    <div style="float: left; width: 175px;">
                        <input type="text" id="T_starttime1" name="T_starttime1" ltype="date" ligerui="{width:172,showTime:true}" /></div>
                    <div style="float: left; width: 175px;">
                        <input type="text" id="T_endtime1" name="T_endtime1" ltype="date" ligerui="{width:176,showTime:true}" /></div>
                </td>
            </tr>
            <tr id="tr6">
                <td>
                ...
                <td>
                    <textarea id="T_content1" cols="5" name="T_content1" class="l-textarea" style="width: 350px;" rows="3"></textarea></td>
            </tr>
