...
<head>
    ...
    <script type="text/javascript">
        ...
        function getuserinfo() {
            $.getJSON("data/Base.ashx?Action=GetUserInfo&rnd=" + Math.random(), function (data, textStatus) {
                //判断是否为qq登录 如果是需要显示 qq的相关信息                 
                $.get("data/qqMessageList.ashx?Action=GetUserInfoLoginType&rnd=" + Math.random(), function (data1, textStatus) {
                    if (data1 == 'ab') {
                        ...
                        if (jsondata.qqid == "") {
                            ...
                            $("#Username").html(data.name + "  QQ昵称:" + jsondata.qqnc);
                            $("#userheader").attr("src", jsondata.face);
                        }
                    }
    ...
    <style type="text/css">
        ...
        .menulist {
            ...
            .menulist li {
                ...
                .menulist li.over, .menulist li.selected {
                    background: url('Images/index/menuitem.gif') repeat-x 0px 0px;
                }

                    .menulist li.over .menuitem-l, .menulist li.selected .menuitem-l {
                        background: url('Images/index/menuitem.gif') repeat-x 0px -24px;
                        width: 2px;
                        height: 24px;
                        position: absolute;
                        left: 0;
                    ...
                    .menulist li.over .menuitem-r, .menulist li.selected .menuitem-r {
                        background: url('Images/index/menuitem.gif') repeat-x -1px -24px;
                        width: 2px;
                        height: 24px;
                        position: absolute;
                        right: 0;
        ...
        #portrait {
            ...
            right: 7px;
            top: 10px;
            background: #d2d2f2 /*url(images/icons/32X32/user.gif) no-repeat center center*/;
          ...
          <!--  <a href="http://www.xczs.com"  target="_blank"> <img id="Img1" alt="" src="http://www.xczs.co/images/logo/201505231548351C5EC2.png" style="height: 42px; margin-left: 5px; margin-top: 2px;" /></a>-->
                ...
                <div style="float: right; width: 220px; height: 47px; margin-right: 65px;">
                    ...
                    <div style="width: 100%; height: 22px; line-height: 22px; vertical-align: bottom;">
                        <%--<div id="labelwelcome" style="font-size: 12px; padding-right: 5px; width: 115px; margin-right: 260px; position: absolute; text-align: right;"></div>--%>
                        <div id="Username" style="font-size: 12px; color: Red; padding-left: 18px; background: url(images/user.jpg) no-repeat left center; width: 250px; float: left;"></div>
                    </div>
                </div>
