...
namespace XHD.BLL
{
    ...
    {
        private readonly XHD.DAL.CRM_receive dal = new XHD.DAL.CRM_receive();
        public CRM_receive()
        { }
        #region  Method
        /// <summary>
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(XHD.Model.CRM_receive model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(XHD.Model.CRM_receive model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public XHD.Model.CRM_receive GetModel(int id)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public XHD.Model.CRM_receive GetModelByCache(int id)
        {
            ...
            return (XHD.Model.CRM_receive)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.CRM_receive> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.CRM_receive> DataTableToList(DataTable dt)
        {
            List<XHD.Model.CRM_receive> modelList = new List<XHD.Model.CRM_receive>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                XHD.Model.CRM_receive model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new XHD.Model.CRM_receive();
