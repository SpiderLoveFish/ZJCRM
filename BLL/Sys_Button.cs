...
namespace XHD.BLL
{
	...
	public partial class Sys_Button
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public XHD.Model.Sys_Button GetModelByCache(int Btn_id)
		{
			...
			return (XHD.Model.Sys_Button)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.Sys_Button> GetModelList(string strWhere)
		{
