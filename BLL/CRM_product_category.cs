...
namespace XHD.BLL
{
	...
	{
		private readonly XHD.DAL.CRM_product_category dal=new XHD.DAL.CRM_product_category();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public XHD.Model.CRM_product_category GetModelByCache(int id)
		{
			...
			return (XHD.Model.CRM_product_category)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.CRM_product_category> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.CRM_product_category> DataTableToList(DataTable dt)
		{
			List<XHD.Model.CRM_product_category> modelList = new List<XHD.Model.CRM_product_category>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XHD.Model.CRM_product_category model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new XHD.Model.CRM_product_category();
