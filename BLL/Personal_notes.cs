...
namespace XHD.BLL
{
	...
	public partial class Personal_notes
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public XHD.Model.Personal_notes GetModelByCache(int id)
		{
			...
			return (XHD.Model.Personal_notes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.Personal_notes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.Personal_notes> DataTableToList(DataTable dt)
		{
			List<XHD.Model.Personal_notes> modelList = new List<XHD.Model.Personal_notes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XHD.Model.Personal_notes model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new XHD.Model.Personal_notes();
