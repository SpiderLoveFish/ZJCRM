...
{
	/// <summary>
	/// public_help_category
	/// </summary>
	public partial class public_help_category
	{
		private readonly XHD.DAL.public_help_category dal=new XHD.DAL.public_help_category();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public XHD.Model.public_help_category GetModelByCache(int id)
		{
			
			string CacheKey = "public_help_categoryModel-" + id;
			...
			return (XHD.Model.public_help_category)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.public_help_category> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.public_help_category> DataTableToList(DataTable dt)
		{
			List<XHD.Model.public_help_category> modelList = new List<XHD.Model.public_help_category>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XHD.Model.public_help_category model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new XHD.Model.public_help_category();
