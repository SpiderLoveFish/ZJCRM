...
{
	/// <summary>
	/// hr_socialWorker_Follow
	/// </summary>
	public partial class hr_socialWorker_Follow
	{
		private readonly XHD.DAL.hr_socialWorker_Follow dal=new XHD.DAL.hr_socialWorker_Follow();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public XHD.Model.hr_socialWorker_Follow GetModelByCache(int id)
		{
			
			string CacheKey = "hr_socialWorker_FollowModel-" + id;
			...
			return (XHD.Model.hr_socialWorker_Follow)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.hr_socialWorker_Follow> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.hr_socialWorker_Follow> DataTableToList(DataTable dt)
		{
			List<XHD.Model.hr_socialWorker_Follow> modelList = new List<XHD.Model.hr_socialWorker_Follow>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XHD.Model.hr_socialWorker_Follow model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new XHD.Model.hr_socialWorker_Follow();
