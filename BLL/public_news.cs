...
namespace XHD.BLL
{
    ...
    {
        private readonly XHD.DAL.public_news dal = new XHD.DAL.public_news();
        public public_news()
        { }
        #region  Method
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public XHD.Model.public_news GetModelByCache(int id)
        {
            ...
            return (XHD.Model.public_news)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.public_news> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.public_news> DataTableToList(DataTable dt)
        {
            List<XHD.Model.public_news> modelList = new List<XHD.Model.public_news>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                XHD.Model.public_news model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new XHD.Model.public_news();
