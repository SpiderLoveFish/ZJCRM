...
namespace XHD.DAL
{
	...
	public partial class Financial_Fixed_Cost
	{
		...
		public bool Exists(string F_Num)
		{
			...
			strSql.Append("select count(1) from Financial_Fixed_Cost");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(XHD.Model.Financial_Fixed_Cost model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Financial_Fixed_Cost(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(XHD.Model.Financial_Fixed_Cost model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Financial_Fixed_Cost set ");
		...
		public bool Delete(string F_Num)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Financial_Fixed_Cost ");
			strSql.Append(" where F_Num=@F_Num ");
			SqlParameter[] parameters = {
					new SqlParameter("@F_Num", SqlDbType.VarChar,20)			};
			parameters[0].Value = F_Num;
		...
		/// 得到一个对象实体
		/// </summary>
		public XHD.Model.Financial_Fixed_Cost GetModel(string F_Num)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 F_Num,F_StyleID,F_StyleName,cwny,Amount,RelevantPerson,Remarks,FromWhere,CreatePerson,CreateTime,IsStatus,DeleteTime,Pay_type_id,Pay_type from Financial_Fixed_Cost ");
			strSql.Append(" where F_Num=@F_Num ");
			SqlParameter[] parameters = {
					new SqlParameter("@F_Num", SqlDbType.VarChar,20)			};
			parameters[0].Value = F_Num;

			XHD.Model.Financial_Fixed_Cost model=new XHD.Model.Financial_Fixed_Cost();
		...
		/// 得到一个对象实体
		/// </summary>
		public XHD.Model.Financial_Fixed_Cost DataRowToModel(DataRow row)
		{
			XHD.Model.Financial_Fixed_Cost model=new XHD.Model.Financial_Fixed_Cost();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Financial_Fixed_Cost ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Financial_Fixed_Cost T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Financial_Fixed_Cost";
        ...
        public DataSet GetListPage(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
        {
            ...
            strSql.Append("select ");
            strSql.Append(" top " + PageSize + "  * from Financial_Fixed_Cost");
            ...
            strSql1.Append(" select count(F_Num) FROM Financial_Fixed_Cost  ");
            if (strWhere.Trim() != "")
            {
