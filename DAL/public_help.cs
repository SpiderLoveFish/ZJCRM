...
namespace XHD.DAL
{
    ...
    public partial class public_help
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "public_help");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from public_help");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into public_help(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update public_help set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from public_help ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public XHD.Model.public_help GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,category_id,category_name,create_id,create_name,create_time,isDelete,Delete_time,title,t_content,orderid from public_help ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;

            XHD.Model.public_help model = new XHD.Model.public_help();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM public_help ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
        {
            ...
            strSql.Append("select ");
            strSql.Append(" top " + PageSize + " * FROM public_help ");
            strSql.Append(" WHERE id not in ( SELECT top " + (PageIndex - 1) * PageSize + " id FROM public_help ");
            strSql.Append(" where " + strWhere + " order by " + filedOrder + " ) ");
            strSql1.Append(" select count(id) FROM public_help ");
            if (strWhere.Trim() != "")
            {
