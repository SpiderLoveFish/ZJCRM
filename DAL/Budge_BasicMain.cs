...
namespace XHD.DAL
{
	...
	public partial class Budge_BasicMain
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Budge_BasicMain"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(XHD.Model.Budge_BasicMain model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Budge_BasicMain(");
			strSql.Append("customer_id,BudgetName,DoPerson,DoTime,IsStatus,ProjectDirectCost,DirectCostDiscount,AdditionalCost,BudgetAmount,DiscountAmount,CostAmount,SigningAmount,SigningTime,Profit,Remarks,Mmaterial,MmaterialDiscount,fbAmount)");
		...
		/// 得到一个对象实体
		/// </summary>
		public XHD.Model.Budge_BasicMain GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,customer_id,BudgetName,DoPerson,DoTime,IsStatus,ProjectDirectCost,DirectCostDiscount,AdditionalCost,BudgetAmount,DiscountAmount,CostAmount,SigningAmount,SigningTime,Profit,Remarks,Mmaterial,MmaterialDiscount,fbAmount from Budge_BasicMain ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,customer_id,BudgetName,DoPerson,DoTime,IsStatus,ProjectDirectCost,DirectCostDiscount,AdditionalCost,BudgetAmount,DiscountAmount,CostAmount,SigningAmount,SigningTime,Profit,Remarks,Mmaterial,MmaterialDiscount,fbAmount ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,customer_id,BudgetName,DoPerson,DoTime,IsStatus,ProjectDirectCost,DirectCostDiscount,AdditionalCost,BudgetAmount,DiscountAmount,CostAmount,SigningAmount,SigningTime,Profit,Remarks,Mmaterial,MmaterialDiscount,fbAmount ");
			strSql.Append(" FROM Budge_BasicMain ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
