...
namespace XHD.DAL
{
    ...
    public partial class hr_socialWorker
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from hr_socialWorker");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from hr_socialWorker ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
        ...
        public XHD.Model.hr_socialWorker GetModel(int ID)
        {
            ...
            XHD.Model.hr_socialWorker model = new XHD.Model.hr_socialWorker();
        ...
        /// <returns></returns>
        public bool PersonalUpdate(XHD.Model.hr_socialWorker model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update hr_socialWorker set ");
            strSql.Append("name=@name,");
        ...
        ///     更新默认城市
        /// </summary>
        public bool UpdateDefaultCity(Model.hr_socialWorker model)
        {
