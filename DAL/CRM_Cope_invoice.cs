...
namespace XHD.DAL
{
	...
	public partial class CRM_Cope_invoice
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "CRM_Cope_invoice"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from CRM_Cope_invoice");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into CRM_Cope_invoice(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CRM_Cope_invoice set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CRM_Cope_invoice ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		public XHD.Model.CRM_Cope_invoice GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,Customer_id,Customer_name,invoice_num,invoice_type_id,invoice_type,invoice_amount,invoice_content,invoice_date,C_depid,C_depname,C_empid,C_empname,create_id,create_name,create_date,order_id,isDelete,Delete_time from CRM_Cope_invoice ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			XHD.Model.CRM_Cope_invoice model=new XHD.Model.CRM_Cope_invoice();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM CRM_Cope_invoice ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
		{
			...
			strSql.Append("select ");
			strSql.Append(" top " + PageSize + " * FROM CRM_Cope_invoice ");
			strSql.Append(" WHERE id not in ( SELECT top " + (PageIndex - 1) * PageSize + " id FROM CRM_Cope_invoice ");
			strSql.Append(" where " + strWhere + " order by " + filedOrder + " ) ");
			strSql1.Append(" select count(id) FROM CRM_Cope_invoice ");
			if (strWhere.Trim() != "")
			{
