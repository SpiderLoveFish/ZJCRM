...
namespace XHD.DAL
{
    ...
    public partial class CRM_Cope
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "CRM_Cope");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from CRM_Cope");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into CRM_Cope(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CRM_Cope set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from CRM_Cope ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
        ...
        public XHD.Model.CRM_Cope GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,Customer_id,Customer_name,Receive_num,Pay_type_id,Pay_type,Receive_amount,Receive_date,C_depid,C_depname,C_empid,C_empname,create_id,create_name,create_date,companyid,order_id,remarks,isDelete,Delete_time from CRM_Cope ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
            ...
            XHD.Model.CRM_Cope model = new XHD.Model.CRM_Cope();
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
        {
            ...
            strSql.Append("select ");
            strSql.Append(" top " + PageSize + " * FROM CRM_Cope ");
            strSql.Append(" WHERE id not in ( SELECT top " + (PageIndex - 1) * PageSize + " id FROM CRM_Cope ");
            strSql.Append(" where " + strWhere + " order by " + filedOrder + " ) ");

            strSql1.Append("select count(id) FROM CRM_Cope ");
