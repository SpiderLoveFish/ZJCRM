...
namespace XHD.Common
{
    ...
    public class SoftReg
    {
        ...
        public string getRNum()
        {
            ...
            MNum = MNum.ToUpper();
            string RegKey = "XHDRC-" + MNum.Substring(5, 5) + "-" + MNum.Substring(19, 5) + "-" + MNum.Substring(36, 5) + "-" + MNum.Substring(49, 5);

            return RegKey;
        }

        public string getMNum(string strPath)
        {
            return DEncrypt.DESEncrypt.Encrypt(strPath).ToUpper();
        }

        public string getRNum(string MNum)
        {
            return System.Text.RegularExpressions.Regex.Replace(DEncrypt.DEncrypt.Encrypt(MNum).ToUpper(), @"[\W]", "");
        }
    }
}
